...
@click.option('-n','--nparallel', default = 2)
def yadage(url, experiment, toplevel, workflow, parameter, archive,nparallel):
    ...
    response = requests.post(url, json=data)
    click.echo('Request Response: {}'.format(response.json()))
